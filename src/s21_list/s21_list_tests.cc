...
TEST(ListConstructors, InitList) {
  s21::s21_list<int> slist = {101, 1111, 212, 8008};
...
TEST(ListConstructors, Copy) {
  s21::s21_list<int> s_list = {101, 1111, 212, 8008};
  s21::s21_list<int> s_copy = s_list;
...
TEST(ListConstructors, Move) {
  s21::s21_list<int> s_list = {101, 1111, 212, 8008};
  s21::s21_list<int> s_moved = std::move(s_list);
...
TEST(ListElementAccess, Front) {
  s21::s21_list<int> slist = {99, 0, -22, -1001, 5999, 1};
...
TEST(ListCapacity, MaxSize) {
  ...
  EXPECT_EQ(slist.max_size(), 384307168202282325);
}
...
TEST(ListModifiers, Swap) {
  s21::s21_list<int> f_slist = {99, 0, -22, -1001, 5999, 1};
  s21::s21_list<int> s_slist = {101, 1111, 212, 8008};
...
TEST(ListModifiers, Merge) {
  s21::s21_list<int> f_slist = {10, 20, 30, 44, 55, 99, 111};
  s21::s21_list<int> s_slist = {0, 1, 2, 33, 41, 56, 100, 1001};
...
TEST(ListModifiers, MergeNotSort) {
  s21::s21_list<int> f_slist = {101, 20, -30, 444, 5, 99, 111};
  s21::s21_list<int> s_slist = {43, 22, 26, 33, 4, 3, 10, 11};
  f_slist.merge(s_slist);
...
TEST(ListModifiers, Reverse) {
  s21::s21_list<int> slist = {101, 20, -30, 444, 5, 99, 111};
...
TEST(ListModifiers, Unique) {
  s21::s21_list<int> slist = {10, -123, 10,  10,  1220, 12, -3,  -3,
