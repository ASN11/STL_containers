...
TEST(MapConstructors, Default) {
  s21::s21_map<std::string, int> s_tree;
...
TEST(MapConstructors, InitList) {
  s21::s21_map<int, std::string> s_tree = {
...
TEST(MapConstructors, Copy) {
  s21::s21_map<int, std::string> s_tree = {
      {10, "ten"},   {20, "twenty"}, {30, "thirty"}, {40, "fourty"},
      {50, "fifty"}, {60, "sixty"},  {70, "seventy"}};
  s21::s21_map<int, std::string> cp_s_tree = s_tree;
...
TEST(MapConstructors, Move) {
  s21::s21_map<int, std::string> s_tree = {
      {10, "ten"},   {20, "twenty"}, {30, "thirty"}, {40, "fourty"},
      {50, "fifty"}, {60, "sixty"},  {70, "seventy"}};
  s21::s21_map<int, std::string> mv_s_tree = std::move(s_tree);
...
TEST(MapElementAccess, At) {
  s21::s21_map<std::string, std::string> s_tree = {
...
TEST(MapCapacity, MaxSize) {
  ...
  EXPECT_EQ(s_tree.max_size(), 128102389400760775);
}
...
TEST(MapModifiers, Swap) {
  s21::s21_map<std::string, int> f_s_tree = {
      {"zero", 0}, {"one", 1}, {"two", 2},   {"three", 3}, {"four", 4},
      {"five", 5}, {"six", 6}, {"seven", 7}, {"eight", 8}, {"nine", 9}};

  s21::s21_map<std::string, int> s_s_tree = {
